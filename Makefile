.PHONY: help hooks build test vet fmt lint vuln check mock demo dev run cli token dexcom strava-check strava-photo strava-list strava-cookies shot mailshot site reset-mock reset-real clean
